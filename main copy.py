...
class Main(QMainWindow): 
    ...
    def prepareHomeTab(self):
        ...
        self.home_page_import_template_btn = QPushButton("Import Template")
        
        self.home_page_import_message_panel_buttons_layout.addWidget(self.home_page_import_message_btn,1)
        self.home_page_import_message_panel_buttons_layout.addWidget(self.home_page_import_template_btn,1)
        ...
        # self.home_page_import_message_panel_layout.addWidget(self.home_page_import_template_btn,1)
    ...
    def populateDataTable(self,key='credentials',cols=[],row=[]): 
        ...
        if key=='credentials':
            ...
            self.delete_function = self.deleteTemplateRecord
            column_names = ["Templates","Operation"]
        elif key=='macros':
            # self.target_table = self.template_macro_table_widget
            column_names = ["Macros","Operation"]
            self.delete_function = self.deleteMacroRecord
    ...
    def deleteTemplateRecord(self):pass
    def deleteMacroRecord(self):pass
    ...
    def prepareTemplatesMacrosTabe(self):
        ...
        # self.populateDataTable() 
        self.credentails_listing_table_layout.addWidget(self.credentials_table_widget)  
        # self.templates_macros_tab_layout.addWidget(self.credentails_listing_table,12)  
